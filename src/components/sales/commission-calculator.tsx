...
const SERVICE_TYPE_CONFIG = {
  turn_1: {
    ...
    timeAdjustment: 0.15,
    dollarAmount: 45.0,
    description: "Maintenance cleaning rotation 1",
  },
  turn_2: {
    name: "Turn 2",
    timeAdjustment: 0.15,
    dollarAmount: 45.0,
    description: "Maintenance cleaning rotation 2",
  },
  turn_3: {
    name: "Turn 3",
    timeAdjustment: 0.15,
    dollarAmount: 45.0,
    description: "Maintenance cleaning rotation 3",
  },
  turn_4: {
    name: "Turn 4",
    timeAdjustment: 0.15,
    dollarAmount: 45.0,
    description: "Maintenance cleaning rotation 4",
  },
  deep_clean_blue: {
  ...
  deep_combo: {
    ...
    timeAdjustment: 0.0,
    dollarAmount: 332.0,
    description: "Combined deep clean",
  },
  move_in_out: {
    name: "Move In/Out",
    timeAdjustment: 0.0,
    dollarAmount: 232.0,
    description: "Moving day cleaning",
  },
  one_time: {
    name: "One-Time",
    timeAdjustment: 0.0,
...
const PROPERTY_TYPE_CONFIG = {
  house: { name: "House", timeAdjustment: 0.324, dollarAmount: 28.0 },
  apartment: { name: "Apartment", timeAdjustment: 0.0, dollarAmount: 0.0 },
  office: { name: "Office", timeAdjustment: 0.4, dollarAmount: 35.0 },
  studio: { name: "Studio", timeAdjustment: 0.0, dollarAmount: 0.0 },
  warehouse: { name: "Warehouse", timeAdjustment: 0.5, dollarAmount: 40.0 },
};

// Frequency adjustments (from spreadsheet)
const FREQUENCY_CONFIG = {
  weekly: { name: "Weekly", timeAdjustment: -0.25, dollarAmount: -40.0 },
  bi_weekly: { name: "Bi-weekly", timeAdjustment: 0.0, dollarAmount: 0.0 },
...
const PET_CONFIG = {
  ...
  dog_cat_3_plus: {
    name: "Dog + Cat (3+ combined)",
    timeAdjustment: 0.375,
    dollarAmount: 22.5,
  },
};
...
const COGS_CONFIG = {
  costingRate: 22.5, // Per hour contractor rate
  suppliesCost: 7.73, // Fixed supplies cost
  transportationCost: 11.6, // Fixed transportation cost
...
export function CommissionCalculator({
  ...
  console.log(
    "🔍 Commission Calculator - UserRole.SALES_REP:",
    UserRole.SALES_REP,
  );
  ...
  console.log(
    "🔍 Commission Calculator - Can view sensitive data:",
    canViewSensitiveData,
  );
  console.log("🔍 Commission Calculator - Is Sales Rep:", isSalesRep);
  console.log(
    "🔍 Commission Calculator - String comparison:",
    userRole === "SALES_REP",
  );
  console.log(
    "🔍 Commission Calculator - Enum comparison:",
  ...
  const [discountBudget, setDiscountBudget] = useState<DiscountBudget | null>(
    null,
  );
  ...
  useEffect(() => {
    const loadDiscountBudget = async () => {
      ...
      try {
        ...
        const mockBudget: DiscountBudget = {
          used: 850,
          limit: 2000,
          period: "Monthly",
    ...
    loadDiscountBudget();
  }, [user?.id, user?.role, canViewSensitiveData]);
  ...
  const calculateBasePrice = () => {
    ...
    const serviceConfig =
      SERVICE_TYPE_CONFIG[serviceType as keyof typeof SERVICE_TYPE_CONFIG];
    if (serviceConfig) {
    ...
    const propertyConfig =
      PROPERTY_TYPE_CONFIG[propertyType as keyof typeof PROPERTY_TYPE_CONFIG];
    if (propertyConfig) {
    ...
    const frequencyConfig =
      FREQUENCY_CONFIG[frequency as keyof typeof FREQUENCY_CONFIG];
    if (frequencyConfig) {
  ...
  const calculateCOGS = (revenue: number) => {
    ...
    const realtorCommission = isRealtor
      ? revenue * COGS_CONFIG.realtorCommissionRate
      : 0; // 3% if realtor
  ...
  const wouldExceedBudget =
    discountBudgetUsed + discountFromBaseline > discountBudgetLimit;
  ...
  return (
    <div className="space-y-6 max-h-[90vh] overflow-y-auto pr-2 -mr-2">
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <div className="text-yellow-700 text-xs">
                Some features may be limited. If you&apos;re experiencing
                issues, try refreshing the page or logging in again.
              </div>
            </div>
          </div>
        </div>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex space-x-1 bg-gray-50 p-1 rounded-lg">
            ...
            <button
              ...
              onClick={() =>
                document
                  .getElementById("commission-pricing")
                  ?.scrollIntoView({ behavior: "smooth" })
              }
              className="flex-1 px-3 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-white rounded-md transition-colors"
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <FormItem>
                ...
                >
                  ...
                  <SelectContent>
                    {Object.entries(PROPERTY_TYPE_CONFIG).map(([key, prop]) => (
                    ...
                    <>
                      <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                        ...
                        <div className="text-xs text-green-600 mt-1">
                          This is the minimum profitable price based on time
                          calculation
                        </div>
                      </div>
                      ...
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                          ...
                          <div className="space-y-2">
                            <div className="font-medium text-red-800 mb-2">
                              Low Price Impact (${(basePrice * 1.03).toFixed(2)}
                              ):
                            </div>
                            <div className="flex justify-between">
                              <span>Commission per sale:</span>
                              <span className="font-medium text-red-600">
                                $
                                {((basePrice * 1.03 - basePrice) * 0.2).toFixed(
                                  2,
                                )}
                              </span>
                            </div>
                        ...
                        <div className="mt-3 pt-3 border-t border-blue-200">
                          <div className="text-xs text-blue-700">
                            <strong>💡 Sales Tip:</strong> The market
                            recommended price maximizes your commission while
                            remaining competitive. Higher pricing = higher
                            commissions!
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setQuotedPriceOverride(e.target.value)
                            }
                          ...
                          <div className="flex justify-between text-xs text-gray-500 mt-1">
                            ...
                            <span>
                              Market: ${(basePrice * 1.45).toFixed(0)}
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-3 text-xs">
                          <div className="text-center p-2 bg-red-50 rounded">
                            ...
                            <div className="text-red-600">
                              $
                              {((basePrice - cogsAnalysis.total) * 0.2).toFixed(
                                0,
                              )}
                            </div>
                          </div>
                          ...
                          <div className="text-center p-2 bg-green-50 rounded">
                            ...
                            <div className="text-green-600">
                              $
                              {(
                                (basePrice * 1.45 - cogsAnalysis.total) *
                                0.49
                              ).toFixed(0)}
                            </div>
                          </div>
                        ...
                        <div className="bg-blue-50 rounded p-2 text-center">
                          <div className="text-xs text-blue-700 mb-1">
                            Annual Potential (100 customers)
                          </div>
                    ...
                    <details className="group">
                      ...
                      <div className="mt-2">
                        <Input
                          ...
                          placeholder={
                            basePrice > 0 ? basePrice.toFixed(2) : "Enter price"
                          }
                        ...
                        {parseFloat(quotedPriceOverride) < basePrice && (
                          <div className="flex items-center gap-2 text-red-600 text-sm bg-red-50 p-2 rounded">
                            ...
                            <span className="font-medium">
                              Below baseline by $
                              {(
                                basePrice - parseFloat(quotedPriceOverride)
                              ).toFixed(2)}{" "}
      ...
      <div id="commission-pricing">
        <h3 className="text-lg font-semibold text-gray-900 border-b pb-2 mb-6">
          Commission & Pricing
        </h3>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 space-y-2">
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    <div className="border-t pt-1 flex justify-between font-medium">
                      ...
                      <span>
                        {getTimeBreakdown().totalTime.toFixed(3)} hours
                      </span>
                    </div>
                  </div>
                  {canViewSensitiveData && (
            ...
            <div className="flex justify-between items-center">
              <span>
                {quotedPriceOverride ? "Sales Price:" : "Baseline Price:"}
                {quotedPriceOverride && basePrice > 0 && (
                  <span
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    {cogsAnalysis.realtorCommission > 0 && (
                      <div className="flex justify-between">
                        ...
                        <span>
                          ${cogsAnalysis.realtorCommission.toFixed(2)}
                        </span>
                      </div>
                    )}
                    <div className="border-t pt-1 flex justify-between font-medium">
            ...
            {finalPrice > 0 && !canViewSensitiveData && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                ...
                <div className="text-blue-600 text-sm">
                  ...
                  profitability. Focus on providing excellent customer value
                ...
                <div className="space-y-1 text-sm">
                  ...
                  {wouldExceedBudget && (
                    <div className="text-red-600 font-medium text-xs mt-1">
                      ...
                      {discountBudget?.period?.toLowerCase() || "monthly"}{" "}
                      budget!
                    </div>
                  )}
                </div>
            ...
            {needsManagerApproval && (
              <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                ...
                <div className="text-red-700 text-sm space-y-1">
                  <div>
                    • Price is ${discountFromBaseline.toFixed(2)} below baseline
                  </div>
                  {wouldExceedBudget && (
                    <div>• Would exceed monthly discount budget</div>
                  )}
                  <div className="text-xs mt-2 mb-3 p-2 bg-red-100 rounded">
                    <strong>Baseline protection:</strong> Sales reps cannot sell
                    below the calculated baseline price without manager approval
                    to ensure profitability.
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="text-xs">
                      Request approval from your sales manager to proceed below
                      baseline.
                    </div>
                    <Button
                      variant="outline"
        ...
        {canViewSensitiveData && (
          <Card>
            <CardHeader>
              <CardTitle>
                Commission Tier Guide (Based on Gross Margin)
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
        ...
        <Card>
          ...
          <CardContent>
            <ul className="space-y-2 text-sm">
              ...
              <li>
                • Deep cleaning services have higher margins than regular
                cleaning
              </li>
              <li>
              ...
              <div className="space-y-4">
                  ...
                  <Button
                    onClick={() => {
                      ...
                      if (onCreateEstimate) {
                        ...
                        console.warn(
                          "⚠️ onCreateEstimate callback not provided",
                        );
                      }
                    }}
                ...
                {needsManagerApproval && (
                  <p className="text-center text-sm text-red-600">
                    Price below baseline - please adjust price or get manager
                    approval
                  </p>
                )}
